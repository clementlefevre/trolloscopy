...
from config import LIVEFYRE_RAW_FILES_FOLDER, FT_ID_RAW_FILES_FOLDER
...
def read_all_FT_IDS():
    ...
    df = pd.read_csv(FT_ID_RAW_FILES_FOLDER+"/FT_ID_all.csv", index_col=0)
...
def get_ALL_COMMENTS():
    ...
    df_all_authors.to_csv(LIVEFYRE_RAW_FILES_FOLDER+'/'+'df_authors_'+str(i)+'.csv', encoding='utf-8',sep=';')
    df_all_comments.to_csv('df_comments_'+str(i)+'.csv', encoding='utf-8',sep=';')
